    ...
    <section ref={sectionRef} className="relative  h-screen w-full overflow-hidden">
      ...
      <div className="relative z-[3] flex h-full flex-col">
        ...
        <div className="relative flex-1">
          ...
          <div
            ref={aboutRef}
            className="absolute opacity-0 inset-0 flex h-full items-center px-[20px] sm:px-[40px] md:px-[60px] lg:px-[90px]"
          >
            <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-8 md:flex-row md:items-center md:justify-center lg:gap-16">
              <div
                ref={photoRef}
